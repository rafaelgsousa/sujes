    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expected_return', models.DateTimeField(default=datetime.datetime(2024, 3, 5, 0, 1, 24, 440284, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[(0, 'Monthly'), (1, 'bimonthly'), (2, 'bimonthly recovery'), (3, 'semi-annual recovery')], default=0, max_length=25)),
                ('school_subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.schoolsubject')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.student')),
            ],
        ),
